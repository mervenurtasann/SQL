...
2) CONSTRAINT(kisitlama) Keyword Kullanilarak Primary Key Tanimlanabilir; 
...
giris_yili CHAR(10),
giris_siralamasi VARCHAR(25),
isim VARCHAR(25) NOT NULL,
bolum VARCHAR(25),
CONSTRAINT id_isim_pk PRIMARY KEY (giris_yili,giris_siralamasi) 
);
